<template>
  <div>
    ...
    <div>
      <DragAndDropSortingStatement :options="options" @updateOrder="updateOrder"/>
    </div>
  </div>
</template>
...
@Component({
  components: { DragAndDropSortingStatement, SurveyProgress }
})
export default class TestDragAndDropPage extends Vue {
